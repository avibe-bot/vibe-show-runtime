...
describe("legacy theme compatibility", () => {
  ...
  it("serializes the opaque stylesheet state observers", () => {
    ...
    expect(script).toContain("hasActiveShadowHostThemeMotion")
    expect(script).toContain("new ResizeObserver(scheduleShadowHostThemeRefresh)")
    expect(script).toContain("hasActiveThemeMotion")
    expect(script).toContain("changed || themeMotionActive")
    expect(script).toContain('patchThemeMotionMethod(elementPrototype, "animate")')
    expect(script).toContain('root.addEventListener("scroll", scheduleOpaqueLegacyRelationalEventScan, true)')
    expect(script).toContain('root.addEventListener("scrollend", scheduleOpaqueLegacyRelationalEventScan, true)')
    ...
    expect(script).toContain('"enterpictureinpicture"')
    expect(script).toContain('"leavepictureinpicture"')
