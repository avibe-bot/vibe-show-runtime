      ...
      <main class="avs-fallback">
        ...
        <div class="avs-fallback-grid">
          <div class="avs-fallback-panel">
            ...
            <textarea id="avs-agent-prompt" readonly>Please repair this Vibe Remote Show Page. Open the Show Page workspace, read the local Show Page/runtime instructions, then replace src/App.tsx with a polished React page. Use the shadcn-style components from @/components/ui and Tailwind CSS v4 utility classes (available in any className). Keep the existing CSS imports at the top of src/styles.css. Use standard shadcn theme variables such as --background, --foreground, --primary, --border, and --radius. Do not edit index.html unless it is required. If the browser shows Ready to visualize, check src/App.tsx, src/main.tsx, src/styles.css, and the Vite/browser console for compile or runtime errors. Make the page responsive and verify it renders.</textarea>
