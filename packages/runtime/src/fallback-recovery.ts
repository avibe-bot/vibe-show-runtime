      ...
      <main class="avs-fallback">
        ...
        <div class="avs-fallback-grid">
          <div class="avs-fallback-panel">
            ...
            <textarea id="avs-agent-prompt" readonly>Please repair this Vibe Remote Show Page. Open the Show Page workspace, read the local Show Page/runtime instructions, then replace src/App.tsx with a polished React page. Use shadcn-style components from @/components/ui and Tailwind CSS v4 utility classes in className. Keep @import "tailwindcss"; followed by @import "@avibe/show-ui/theme.css"; at the top of src/styles.css. Use standard theme variables such as --background, --foreground, --card, --primary, --muted, --border, --ring, and --radius. Do not edit index.html unless it is required. If the browser shows Ready to visualize, check src/App.tsx, src/main.tsx, src/styles.css, and the Vite/browser console for compile or runtime errors. Make the page responsive and verify it renders.</textarea>
          ...
          <div class="avs-fallback-panel">
            ...
            <ul>
              ...
              <li>Tailwind utilities and standard shadcn theme variables work without private token names.</li>
            </ul>
          </div>
        </div>
      </main>
