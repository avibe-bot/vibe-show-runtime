...
Vite SSR module graph, renders the initial React tree in a terminable worker,
removes non-semantic and annotation-overlay markup, and returns GFM Markdown.
